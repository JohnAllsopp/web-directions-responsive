...
var map;var conference=new google.maps.LatLng(-37.815107,144.966499);var workshops=new google.maps.LatLng(-37.815471,144.960684);function initialise(){var i=[{stylers:[{saturation:-100}]},{featureType:"road",elementType:"geometry",stylers:[{hue:"#ac090a"},{saturation:50},{lightness:0},{visibility:"on"}]},{featureType:"road",elementType:"labels.text.fill",stylers:[{weight:0},{lightness:10}]},{featureType:"road",elementType:"labels.text.stroke",stylers:[{weight:0},{lightness:80}]}];var c={zoom:14,center:conference,mapTypeControl:false,disableDefaultUI:true,scrollwheel:false,};map=new google.maps.Map(document.getElementById("venue-map"),c);var f="ffffff";var k=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|"+f,new google.maps.Size(21,34),new google.maps.Point(0,0),new google.maps.Point(10,34));var d="bbbbbb";var j=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|"+d,new google.maps.Size(21,34),new google.maps.Point(0,0),new google.maps.Point(10,34));var e=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_shadow",new google.maps.Size(40,37),new google.maps.Point(0,0),new google.maps.Point(12,35));var b=new google.maps.Marker({position:conference,map:map,title:"Melbourne Town Hall - Conference Venue",icon:k,shadow:e});var a=new google.maps.Marker({position:workshops,map:map,title:"Karstens on Queen - Workshop Venue",icon:j,shadow:e});var g={map:map,name:"Venue Map",minZoom:5,};var h=new google.maps.StyledMapType(i,g);map.mapTypes.set("Venue Map",h);map.setMapTypeId("Venue Map")}initialise();